...
<html lang="fr">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../style/lstpt.css">
	</head>
	...
	<body>
		...
		<?php if (isset($type) && $type !== "gerant") { ?>	
			...
			<form action="lstpt.php" method="post">
				...
				<?php
					$temp_2 = $bdd->query('SELECT DISTINCT moisPt FROM points ORDER BY moisPt DESC');

					while ($temps_2 = $temp_2->fetch()) {
				?>	
					<option value="<?php echo $temps_2['moisPt'];?>">
						<?php
							echo $temps_2['moisPt'];
						?>
					</option>
				...
				<?php
					$temp_3 = $bdd->query('SELECT DISTINCT anneePt FROM points ORDER BY anneePt DESC');

					while ($temps_3 = $temp_3->fetch()) {
				?>	
					<option value="<?php echo $temps_3['anneePt'];?>">
						<?php
							echo $temps_3['anneePt'];
						?>
					</option>
				<?php
					}
			...
			<div class="wrap" id="wrapmois" style = "<?php echo $wrapm ; ?>">
				<?php
					$reponse = $bdd->query("SELECT * FROM points WHERE moisPt ='$_sltmois'");

					while ($don = $reponse->fetch()) {
				?>	
				<a href="detConso.php?day=<?=$don['dayPt']?>&amp;heure=<?=$don['heurePt']?>" style="text-decoration: none;color: black;">
							...
							<div class="container">
								...
								<table>
									<tr>
										...
										<td> : 
											<span style="color: red;"><?php echo $don['dayPt']; ?></span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Heure</td>
										<td> : 
											<span style="color: red;"><?php echo $don['heurePt']; ?></span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Estimation des<br>commandes</td>
										<td> : 
											<span style="color: red"><?php echo $don['estcomPt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Estimation du stock<br>avant point</td>
										<td> : 
											<span style="color: red"><?php echo $don['eststkPt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Montant vente</td>
										<td> : 
											<span style="color: red"><?php echo $don['mntvtePt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Bénéfice</td>
										<td> : 
											<span style="color: red"><?php echo $don['benefPt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Montant reçu</td>
										<td> : 
											<span style="color: red"><?php echo $don['mntrPt']; ?> FCFA</span>
										</td>
									</tr>
									...
									<tr>
										...
										<td> : 
											<span style="color: red"><?php echo $don['ekaPt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Dépenses</td>
										<td> : 
											<span style="color: red"><?php echo $don['dpsePt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Crédit</td>
										<td> : 
											<span style="color: red"><?php echo $don['crdPt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Autres</td>
										<td> : 
											<span style="color: red"><?php echo $don['autrPt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Estimation du<br>stock  Manquant</td>
										<td> : 
											<span style="color: red"><?php echo $don['mankPt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Estimation du stock<br>après point</td>
										<td> : 
											<span style="color: red"><?php echo $don['estsapPt']; ?> FCFA</span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Nom du gérant</td>
										<td> : 
											<span style="color: red"><?php echo $don['nomGer']; ?></span>
										</td>
									</tr>
									<tr>
										<td style="text-align: right;">Nom du contrôleur</td>
										<td> : 
											<span style="color: red"><?php echo $don['nomCrtl']; ?></span>
										</td>
									</tr>
								</table>
								<br>
			...
			<div class="wrap" id="wrapannee" style = "<?php echo $wrapa ; ?>">
				<?php
					$reponse = $bdd->query("SELECT * FROM points WHERE anneePt = '$_sltannee'");
